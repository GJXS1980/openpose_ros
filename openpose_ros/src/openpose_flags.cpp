...
// OpenPose
DEFINE_string(model_folder,             "/home/hgrd/test_ws/src/openpose_ros/openpose_ros/models/",      "Folder path (absolute or relative) where the models (pose, face, ...) are located.");
